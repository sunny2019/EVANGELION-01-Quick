...
public class Question
{
    ...
    [Title("TopicSpriteSetting")]
    public bool topicHaveSprite;
    [ShowIf("topicHaveSprite")]
    [HideLabel]
    ...
    [Title("OptionSetting")]
    public bool optionIsSprite;
    
    [HideIf("optionIsSprite")]
    public List<TxtChoice> txtChoices;
    
    [ShowIf("optionIsSprite")]
    public List<SpriteChoice> spriteChoices;
    
    public List<ChoiceIndexStr> CorrectOption;
    
    [Title("AnalyzeContentSetting")]
    [Multiline(3)]
    [HideLabel]
