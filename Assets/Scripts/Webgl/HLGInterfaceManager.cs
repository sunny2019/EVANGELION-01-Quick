...
namespace HLGInterface
{
    public static class HLGInterfaceManager
    {
            ...
            Action<UserInfo> successCallBack)
        {
            ...
            mono.StartCoroutine(WebRequestFrom(url, new[] {"param"}, new[] {jsonData},
                true, true, () =>
                {
                    failureCallBack?.Invoke();
                }, (result) =>
            ...
            Action<StatusInfo> successCallBack)
        {
            ...
            mono.StartCoroutine(WebRequestFrom(url, new[] {"param"},
            ...
            Action<StatusInfo> successCallBack)
        {
            ...
            mono.StartCoroutine(WebRequestFrom(url, new[] {"param"}, new[] {reportData},
                false, false, () =>
                {
                    failureCallBack?.Invoke();
                }, (result) =>
        ...
        private static IEnumerator WebRequestFrom(string url, string[] fromKey, string[] fromValue, bool sendBase64,
