...
namespace XChartsDemo
{
    ...
    internal class Demo_Performance : MonoBehaviour
    {
        ...
        private XCharts.LineChart fpsChart;
        private XCharts.LineChart lineChart;
        private BarChart barChart;
        private Text fpsText;

        void Awake()
        {
            fpsChart = transform.Find("fps/FpsChart").gameObject.GetComponent<XCharts.LineChart>();
            lineChart = transform.Find("charts/LineChart").gameObject.GetComponent<XCharts.LineChart>();
